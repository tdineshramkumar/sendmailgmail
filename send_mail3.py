...
SERVER_PORT = 465
email_username = from_address = "*****@gmail.com"       # ENTER USERNAME HERE
email_password = "*********"                            # ENTER PASSWORD HERE

SHORT_OPTIONS = "hs:A:t:c:b:p"   # Help, Subject, Attachments, To, CC, BCC, Print
LONG_OPTIONS = ["help", "subject=", "attach=", "to=", "cc=", "bcc=", "print"]
...
def usage():
    ...
    print("--print, -p\n\t\tTo print the mail")
    print("--help, -h\n\t\tGive the usage")
    print("body is taken from STDIN.")
    print("FROM_ADDRESS is configured in the code")


try:
    opts, _ = getopt(args=sys.argv[1:], shortopts=SHORT_OPTIONS, longopts=LONG_OPTIONS)
